...
script.src = CDN_BASE + "a11y-widget-v1.6.7.js?v=" + new Date().getTime();
```
...
<script src="https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@COMMIT_HASH/a11y-widget-loader-v1.6.7.js" defer></script>
```
