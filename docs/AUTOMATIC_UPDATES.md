...
The widget files (`a11y-widget-v1.6.10.js` and `a11y-widget.css`) are loaded directly from the GitHub repository via jsDelivr CDN.
...
script.src = CDN_BASE + "a11y-widget-v1.6.10.js?v=" + new Date().getTime();
```
...
<script src="https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@COMMIT_HASH/a11y-widget-loader-v1.6.10.js" defer></script>
```
...
<script src="https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@main/a11y-widget-loader-v1.6.10.js?v=<?php echo time(); ?>" defer></script>
```
