...
- `a11y-widget-v1.7.2.js` - Main widget JavaScript (updated runtime)
- `a11y-widget.css` - Widget styles
- `a11y-widget-loader-v1.7.2.js` - Zero-config loader (CDN installs)
...
```bash
# Stage your changes
git add a11y-widget-v1.7.2.js a11y-widget.css a11y-widget-loader-v1.7.2.js
...
If you've made significant changes, update `DEFAULT_VERSION_TAG` in `a11y-widget-loader-v1.7.2.js` (fallback when the script URL has no `@tag`):
...
curl -s "https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.X.X/a11y-widget-v1.7.2.js" | head -20
```
...
```bash
curl "https://purge.jsdelivr.net/gh/braieswabe/A11-Widget@v1.7.2/a11y-widget-v1.7.2.js"
curl "https://purge.jsdelivr.net/gh/braieswabe/A11-Widget@v1.7.2/a11y-widget.css"
curl "https://purge.jsdelivr.net/gh/braieswabe/A11-Widget@v1.7.2/a11y-widget-loader-v1.7.2.js"
```
...
3. Update `DEFAULT_VERSION_TAG` in `a11y-widget-loader-v1.7.2.js`
...
git tag -a v1.7.2 -m "Release: site + docs on v1.7.2, loader default tag"
git push origin v1.7.2

# 5. Verify
curl -s "https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.7.2/a11y-widget-v1.7.2.js" | head -10
```
