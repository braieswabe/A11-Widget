...
function App() {
  useEffect(() => {
    ...
    script.src = 'https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.6.7/a11y-widget-loader-v1.6.7.js'
    script.defer = true
...
<script
  src="https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.6.7/a11y-widget-loader-v1.6.7.js"
  defer
></script>
```
