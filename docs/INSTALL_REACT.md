...
function App() {
  useEffect(() => {
    ...
    script.src = 'https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.7.4/a11y-widget-loader-v1.7.4.js'
    script.defer = true
...
<script
  src="https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.7.4/a11y-widget-loader-v1.7.4.js"
  defer
></script>
```
