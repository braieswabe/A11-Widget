...
function App() {
  useEffect(() => {
    ...
    script.src = 'https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.7.2/a11y-widget-loader-v1.7.2.js'
    script.defer = true
...
<script
  src="https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.7.2/a11y-widget-loader-v1.7.2.js"
  defer
></script>
```
