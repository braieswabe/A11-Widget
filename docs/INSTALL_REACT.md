...
function App() {
  useEffect(() => {
    ...
    script.src = 'https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.7.1/a11y-widget-loader-v1.7.1.js'
    script.defer = true
...
<script
  src="https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.7.1/a11y-widget-loader-v1.7.1.js"
  defer
></script>
```
