...
function App() {
  useEffect(() => {
    ...
    script.src = 'https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@main/a11y-widget-loader-v1.6.8.js'
    script.defer = true
...
<script
  src="https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@main/a11y-widget-loader-v1.6.8.js"
  defer
></script>
```
