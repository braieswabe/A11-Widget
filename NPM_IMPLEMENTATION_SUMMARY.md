...
2. `a11y-widget-v1.6.9.js` - Patched to expose init function
3. `a11y-widget-loader-v1.6.9.js` - Updated to call init function
...
- `packages/a11y-widget/vendor/a11y-widget.core.js` (copied from a11y-widget-v1.6.9.js)
...
**Location**: `a11y-widget.js` and `a11y-widget-v1.6.9.js`
...
**Location**: `a11y-widget-loader-v1.6.9.js`
...
├── vendor/
│   └── a11y-widget.core.js  # Widget core (copied from a11y-widget-v1.6.9.js)
├── assets/
