/*! a11y-widget-loader-v1.7.0.js — Zero-Config Loader v1.7.0
    ...
    <script src="https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.7.0/a11y-widget-v1.7.0.js" defer></script>
...
try {
  console.log('[A11Y Loader] ✅ Script file loaded - v1.7.0 -', new Date().toISOString());
  ...
  console.log('[A11Y Loader] If you see this, the loader script v1.7.0 is executing');
} catch(e) {
...
(function() {
  ...
  var LOADER_VERSION = "1.7"; // Increment this when loader logic changes
  ...
  function checkForUpdates() {
    ...
    xhr.open('HEAD', GITHUB_RAW_BASE + "a11y-widget-v1.7.0.js?nocache=" + now, true);
    xhr.onload = function() {
    ...
    xhr.onerror = function() {
      ...
      xhr2.open('GET', GITHUB_RAW_BASE + "a11y-widget-v1.7.0.js?nocache=" + now, true);
  ...
  function loadWidget() {
    ...
    // GitHub raw serves files as text/plain, which browsers reject
    // Use widget files version in URL path to bypass jsDelivr cache (creates new URL)
    // Load v1.7.0 widget file with toolbar mode and cute logo
    var scriptUrl = CDN_BASE + "a11y-widget-v1.7.0.js?v=" + WIDGET_FILES_VERSION + "&_=" + timestamp + "&nocache=" + timestamp;
    ...
    script.onerror = function() {
      script.src = GITHUB_RAW_BASE + "a11y-widget-v1.7.0.js?v=" + timestamp + "&_=" + random1 + "&nocache=" + timestamp;
    };
