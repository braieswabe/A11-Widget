/*! a11y-widget.js — Accessibility Widget v1.7.2 (IIFE, no deps)
...
(function () {
  ...
  function getPageMetadata(cfg) {
    return {
      ...
      build: window.__A11Y_WIDGET_BUILD__ || "a11y-widget-v1.7.2.js",
  ...
  function postWidgetJsonDetailed(cfg, endpoint, payload) {
    ...
    return fetch(endpoint, {
      ...
      body: JSON.stringify(assign({
        siteId: cfg.siteId,
        url: window.location.href,
        widgetVersion: window.__A11Y_WIDGET_BUILD__ || "a11y-widget-v1.7.2.js",
  ...
  function checkForUpdates(cfg, buttonEl, statusEl) {
    ...
    var probeUrl = CDN_BASE + "a11y-widget-v1.7.2.js?_a11y_check=" + Date.now();
  ...
  function buildWidget(cfg, prefs, onChange, onReset) {
    ...
    var toggle = el("button", {
      ...
      "data-a11y-widget-version": "1.7.2",
      title: (shortcutHint || "Accessibility Settings") + " - Widget v1.7.2",
      html: logoSVG
    });
  ...
  function init(userConfig) {
    ...
    window.__A11Y_WIDGET_BUILD__ = "a11y-widget-v1.7.2.js";
    ...
    function mount() {
      ...
      window.__a11yWidget = {
        ...
        getBuild: function () { return window.__A11Y_WIDGET_BUILD__ || "a11y-widget-v1.7.2.js"; },
