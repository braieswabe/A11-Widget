/*! a11y-widget-loader-v1.6.9.js — Zero-Config Loader v1.6.9
    Usage:
    <script src="https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.6.9/a11y-widget-loader-v1.6.9.js" defer></script>
*/
(function () {
  "use strict";

  var GITHUB_REPO = "braieswabe/A11-Widget";
  var DEFAULT_VERSION_TAG = "v1.6.9";
  var LOADER_VERSION = "1.6.9";
  var CSS_FILE = "a11y-widget.css";
  var JS_FILE = "a11y-widget-v1.6.9.js";
  ...
  function ensureWidgetScript() {
    ...
    var existing = document.getElementById("a11y-widget-script") ||
      document.querySelector('script[src*="a11y-widget-v1.6.9.js"],script[src*="a11y-widget.js"]');
    if (existing) {
