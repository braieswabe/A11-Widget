...
### Entry Point Files
1. **Primary widget**: `a11y-widget.js` / `a11y-widget-v1.6.9.js` (~4,681 lines)
2. **Auto-loader**: `a11y-widget-loader-v1.6.9.js` (loads widget from CDN)
...
1. **GitHub CDN URLs in code**:
   ...
   - `a11y-widget-loader-v1.6.9.js`: Same hardcoded repo paths
...
1. **Multiple entry points**: Which file is the "main" entry?
   - `a11y-widget.js` vs `a11y-widget-v1.6.9.js`
...
3. **Version files**: Multiple versioned files in root
   - `a11y-widget.js`
   - `a11y-widget-v1.6.9.js`
   - `a11y-widget-loader-v1.6.9.js`
