/*! a11y-widget-loader-v1.6.8.js — Zero-Config Loader v1.6.8
    Usage:
...
(function () {
  ...
  function ensureWidgetScript() {
    ...
    var existing = document.getElementById("a11y-widget-script") ||
      document.querySelector('script[src*="a11y-widget-v1.6.8.js"],script[src*="a11y-widget.js"]');
    if (existing) {
