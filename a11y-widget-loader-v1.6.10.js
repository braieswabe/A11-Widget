/*! a11y-widget-loader-v1.6.10.js — Zero-Config Loader v1.6.10
    Usage:
    <script src="https://cdn.jsdelivr.net/gh/braieswabe/A11-Widget@v1.6.10/a11y-widget-loader-v1.6.10.js" defer></script>
*/
(function () {
  "use strict";

  var GITHUB_REPO = "braieswabe/A11-Widget";
  var DEFAULT_VERSION_TAG = "v1.6.10";
  var LOADER_VERSION = "1.6.10";
  var CSS_FILE = "a11y-widget.css";
  var JS_FILE = "a11y-widget-v1.6.10.js";
  ...
  function ensureWidgetScript() {
    ...
    var existing = document.getElementById("a11y-widget-script") ||
      document.querySelector('script[src*="a11y-widget-v1.6.10.js"],script[src*="a11y-widget.js"]');
    if (existing) {
