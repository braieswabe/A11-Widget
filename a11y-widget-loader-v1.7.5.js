/*! a11y-widget-loader-v1.7.5.js — Zero-Config Loader v1.7.5
    Usage:
...
(function () {
  ...
  var DEFAULT_VERSION_TAG = "v1.7.5";
  var LOADER_VERSION = "1.7.5";
  var CSS_FILE = "a11y-widget.css";
  var JS_FILE = "a11y-widget-v1.7.5.js";
  ...
  function ensureWidgetScript() {
    ...
    var existing = document.getElementById("a11y-widget-script") ||
      document.querySelector('script[src*="a11y-widget-v1.7.5.js"],script[src*="a11y-widget.js"]');
    if (existing) {
