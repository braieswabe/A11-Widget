/*! a11y-widget-loader-v1.7.4.js — Zero-Config Loader v1.7.4
    Usage:
...
(function () {
  ...
  var DEFAULT_VERSION_TAG = "v1.7.4";
  var LOADER_VERSION = "1.7.4";
  var CSS_FILE = "a11y-widget.css";
  var JS_FILE = "a11y-widget-v1.7.4.js";
  ...
  function ensureWidgetScript() {
    ...
    var existing = document.getElementById("a11y-widget-script") ||
      document.querySelector('script[src*="a11y-widget-v1.7.4.js"],script[src*="a11y-widget.js"]');
    if (existing) {
